...
if(isset($_POST['dataidbatik'])){
	...
	$query = mysqli_query($mysqli, "SELECT kd_barang,nama_barang,stok FROM tb_pakaian WHERE kd_barang='$kd_barang'") or die('Ada kesalahan pada query tampil data batik: '.mysqli_error($mysqli));
