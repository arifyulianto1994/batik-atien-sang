      ...
      <div class="box box-primary">
        <div class="box-body">
          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            $query = mysqli_query($mysqli, "SELECT * FROM tb_user ORDER BY id_user DESC")
            ...
            <?php
              ...
              echo "      <a data-toggle='tooltip' data-placement='top' title='Ubah' class='btn btn-danger btn-sm' href='?module=form_user&form=edit&id=$data[id_user]'>
