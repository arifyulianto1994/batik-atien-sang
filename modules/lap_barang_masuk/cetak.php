<?php 
	...
	if(isset($_GET['tgl_awal'])){
		...
		$query = mysqli_query($mysqli, "SELECT a.kd_transaksi,a.tanggal_masuk,b.nama_supplier,c.nama_barang,a.jumlah_masuk,a.harga,a.sub_total FROM detail_masuk a, tb_supplier b, tb_pakaian c WHERE a.tanggal_masuk BETWEEN '$tgl_awal' AND '$tgl_akhir' ORDER BY a.kd_transaksi ASC") or die('Ada kesalahan pada query tampil Transaksi : '.mysqli_error($mysqli));
...
<!-- bagian halaman html yg akan dikonvert -->
 <html xmlns="http://www.w3.org/1999/xhtml"> 
 	<head>
 		...
 		<title>LAPORAN BATIK MASUK</title>
 		 	...
 		 	<table width="100" border="0.3" cellpadding="0" cellspacing="0"> 
 		 		<thead style="background: #e8ecee">
 		 			<tr class="tr-title">
 		 				...
 		 				<th height="20" align="center" valign="middle">Nama Supplier</th>
 		 				...
 		 				// jika data tdk ada
 		 					...
 		 					while ($data=mysqli_fetch_assoc($query)){
 		 						...
 		 						echo "<tr>
 		 								...
 		 								<td style='padding-left:10px;' width='155' height='13' valign='middle'>$data[nama_supplier]</td>
 		 								...
 		 								<td style='padding-right:10px;' width='100' height='13' align='right' valign='middle'>$data[harga]</td>
 ...
 <?php 
$filename="LAPORAN BATIK MASUK.pdf";
